...
{% hint style="info" %}
If your store supports multiple [**Languages**](../../start-here/get-started/add-locations-and-languages.md#additional-languages), you will have the option to create separate content for each language in the editor view
{% endhint %}
