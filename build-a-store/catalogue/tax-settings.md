...
To start, set up a **Tax Region** by selecting **Add Tax Region**.  Then select the Tax Region from the listed options - these correspond to the available regions configured via [**Settings > Localization**](../../start-here/get-started/add-locations-and-languages.md)**.**
...
* Override tax rates can be set on a [**Product Category**](create-categories.md#product-categories).
...
<pre><code>&#x3C;tax exclusive calculation example>

<strong>Tax Amount = (product price * tax)% / 100
</strong>price_incl_tax = product price + tax
...
For a summary of all tax collected by tax rate see [**Tax Reports**](../../analytics/tax-reports.md)
