...
{% hint style="info" %}
It's useful to think of Coupon Codes as containers for [**Offers**](./#understanding-offers)**.**  Multiple Offers can be combined into a single Coupon Code.
{% endhint %}

View and track the usage of Coupons via the [**Orders by Coupon**](../../analytics/orders-reports.md#orders-by-coupon) report.
...
Use this setting to attach Offer(s) to the coupon code.  Offers should be non-exclusive, and set up to work in [**combination**](create-and-manage-offers.md#create-and-manage-offers) with each other if you wish to apply multiple offers to a single coupon code.  For coupon codes with Exclusive Offers attached, the highest priority offer will take precedence.
