...
{% hint style="info" %}
Use [**Disputes Reports**](../../analytics/disputes-reports.md) to view and filter disputes aggregated by a variety of metrics
{% endhint %}
...
From the [**Payments**](./#transactions-detail-view) menu, select an individual Transaction, then choose **Actions > Create Dispute.**&#x20;
...
{% hint style="info" %}
Developers and App providers, see [**Disputes Service Apps API Guide**](https://developers.29next.com/docs/apps/guides/dispute-service/)**.**
{% endhint %}
