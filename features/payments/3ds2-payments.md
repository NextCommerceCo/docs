---
description: >-
  Support 3DS2 for SCA-compliant payments in the store checkout and over the
  Admin API
icon: shield-check
---
...
{% hint style="info" %}
To support 3DS2 payments over the Admin API, see the [Developers Guide](https://developers.29next.com/docs/api/admin/guides/3ds2/)
{% endhint %}
