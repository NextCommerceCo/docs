...
- We now have a full suite of Fulfillment APIs for external Fulfillment Services to integrate into the fulfillment flow, see [Fulfillment Service Apps](https://developers.Next Commerce.com/docs/apps/guides/fulfillment-service/) guide for more detail.
