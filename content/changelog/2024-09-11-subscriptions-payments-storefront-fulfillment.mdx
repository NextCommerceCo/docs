...
- Theme templates now feature a suite of [Math Filters ](https://developers.nextcommerce.com/docs/themes/templates/filters/#math)allowing theme developers to perform math operations in their template logic.
