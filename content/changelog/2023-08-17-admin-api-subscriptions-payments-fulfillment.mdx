...
- Merchants can now create [Returns](https://docs.nextcommerce.com/docs/manage/orders/create-and-manage-returns) for products that have been fulfilled through [Order Details](https://docs.nextcommerce.com/docs/manage/orders/order-management#order-details-view) view.
