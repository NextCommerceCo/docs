...
- New customer notifications have been added when orders are Out for Delivery and Delivered to keep customers updated on their shipment statuses. This is supported for stores with [Delivery Tracking](https://docs.nextcommerce.com/docs/apps/delivery-tracking) app installed.
