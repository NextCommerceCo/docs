---
title: Invoice payment requests and customizable products in the Admin API
...
tags:
  ...
  - Admin API
  - Orders
summary: "Merchants can now send an invoice by email to collect payment on an order, and the Admin API now supports customizable products, keeping the same product as separate line items on orders, carts, and subscriptions when each has its own customization details…"
---
