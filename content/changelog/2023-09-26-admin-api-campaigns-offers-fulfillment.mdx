...
- A Product's [Fulfillment Location](https://docs.Next Commerce.com/features/fulfillment-guide/location-based-routing) is now automatically assigned to optimally route fulfillments to: Minimize split fulfillments to reduce shipping costs
...
- [Support Ticket Macros](https://docs.Next Commerce.com/manage/support#support-ticket-macros) have now moved to the main Support section to make them available to create and maintain by all users with access to Support.
