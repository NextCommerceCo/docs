...
- Packages can now be deleted from Campaigns on the [[Campaigns App](https://docs.nextcommerce.com/docs/apps/campaigns-app)](https://docs.Next Commerce.com/apps/campaigns-app).
