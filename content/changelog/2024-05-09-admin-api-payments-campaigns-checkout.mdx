...
- Introducing [3PL Central](https://docs.nextcommerce.com/docs/apps/3pl-central) as a new fully integrated Fulfillment Service App allowing merchants to automate their fulfillment flow with warehouse providers using 3PL Central WMS.
