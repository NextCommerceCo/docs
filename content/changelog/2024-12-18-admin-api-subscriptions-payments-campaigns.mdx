...
tags:
  ...
  - Payments
  - Campaigns
summary: "Introducing [Shop Sync](https://docs.nextcommerce.com/docs/apps/shop-sync), a new app to sync your products from Shopify to Next Commerce, and to sync orders placed in Next Commerce to Shopify for fulfillment. Inventory management is now easier with the ability to update\u2026"
---

## New Features

- Introducing [Shop Sync](https://docs.nextcommerce.com/docs/apps/shop-sync), a new app to sync your products from Shopify to Next Commerce, and to sync orders placed in Next Commerce to Shopify for fulfillment.
