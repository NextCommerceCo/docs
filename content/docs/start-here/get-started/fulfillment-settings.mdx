...
Set up **Allowed Destination Countries** if you want to limit the countries served by this Location.  This is useful as a way to manually route orders from specific countries to designated Fulfillment Location(s), bypassing the [**Location-Based Routing**](/docs/features/fulfillment-guide/location-based-routing) settings.
