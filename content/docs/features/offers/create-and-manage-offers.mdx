...
* **Name -** the Offer's name will be displayed in the customer's cart, and on [**Offers Reports**](/docs/analytics/orders-reports#orders-by-offer).
* **Type -** choose a Site or Voucher offer.  A Site Offer applies to a customer's cart contents globally, while a Voucher Offer only applies when a specific [**Coupon Code**](/docs/features/offers/coupons) is entered.
...
Choose a specific [**Product Range**](/docs/features/offers/product-ranges), from which a product must be in the cart to qualify for the Offer.
