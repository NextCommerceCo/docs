...
description: "Pass UTM, affiliate, and funnel source values with your orders to collect marketing and affiliate attribution data for reporting and partner postbacks."
---
Pass marketing source attribution values with your orders to collect marketing and affiliate attribution data for [**reporting**](/docs/analytics/orders-reports#orders-overview) visibility, and partner marketing postbacks - for example when using tracking extensions like [**Everflow**](/docs/apps/everflow).

Source attribution values are supported on the [**Storefront**](/docs/build-a-store/storefront) checkout and product pages, as well as on custom funnels integrated via the [**Admin API**](https://developers.nextcommerce.com/docs/admin-api).
