...
* **Site Offers:** Offers that apply to customer carts in your [**Storefront**](/docs/build-a-store/storefront) checkout, or on carts created over the [**Admin API**](https://developers.nextcommerce.com/docs/admin-api) or [**Campaigns API**](https://developers.nextcommerce.com/docs/campaigns/api).
...
Applying coupon codes directly from an "Add to Cart" button on the Storefront or Funnels is easy using [**Cart JS API.**](/docs/build-a-store/technical-settings/cart-js-api)

</Callout>

### **Reviewing Offer Performance**

From the [**Order Details View**](/docs/manage/orders/order-management#order-details-view), you can review any Offers that were applied to a customer's order by clicking on the **Discounts** line under **Payment Summary**.

To break down the usage of Offers across your store, and filter by date range, view the summary  [**Orders by Offer**](/docs/analytics/orders-reports#orders-by-offer) and [**Orders by Coupon**](/docs/analytics/orders-reports#orders-by-coupon) reports.
