...
For implementations of PayPal over the Admin API and Campaigns API, including "one click checkout" features, see the [**PayPal Admin API Guide**](https://developers.nextcommerce.com/docs/admin-api/guides/paypal)