---
title: "Payment Failure Cascading"
...
From the [**Payments Settings**](/docs/start-here/get-started/add-payment-providers) follow the following steps to set up decline re-attempts:

* Create a new[ **Gateway Group**](/docs/start-here/get-started/add-payment-providers#create-gateway-groups) to use for re-attempting declined charges
