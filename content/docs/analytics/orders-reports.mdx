...
View a breakdown of orders by where they originated, including Checkout Flow, Subscriptions, Dashboard, and the Admin API. Use this report to separate customer-led purchases from merchant-created or recurring orders.
