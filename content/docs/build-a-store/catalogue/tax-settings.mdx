...
* **Next Tax** - built-in tax calculation with no external service required.
* **TaxJar** - external tax calculation for the United States.
* **Avalara AvaTax** - external tax calculation and reporting for stores using Avalara.

Choose **Settings** on a service to configure its connection details and defaults.
