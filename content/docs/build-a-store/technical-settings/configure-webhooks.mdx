...
capability_ids: [admin-api, webhooks]
---
## Webhooks
...
Webhook deliveries should complete within about 20 seconds; unresponsive endpoints can cause retries and delayed processing.
