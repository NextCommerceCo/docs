...
Developers can leverage a robust pre-built framework [**NEXT Campaigns Cart JS SDK**](https://developers.nextcommerce.com/docs/campaigns/cart-system) to accelerate custom marketing funnel development on Campaigns App.
