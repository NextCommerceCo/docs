...
* **Image** - by default the product's image from the [**store catalogue**](/docs/build-a-store/catalogue) will be assigned to the package. You can upload a different or custom image for this package. **Package images are displayed to customers on the live funnel** — they are served by the SDK and rendered on your checkout and landing pages. Use a high-quality, campaign-appropriate image if the creative requires it.
