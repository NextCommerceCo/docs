...
* **Manage Schedule**\
  Plan future changes to pricing, items, billing intervals, and more. See [**Subscription Schedules**](/docs/manage/subscriptions-guide/subscription-schedules) for full details.<br />
* **Cancel**\
